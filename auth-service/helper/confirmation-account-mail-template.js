...
module.exports=(url)=>{
    return "<!DOCTYPE html>\n" +
        ...
        "                                    <h2>Welcome to School driving platform </h2>\n" +
        "                                    <h3>just one click away, to validate your email and confirm your registration</h3>\n" +
        "                                    <p><a href="+url+" class=\"btn btn-primary\">VALIDATE YOUR EMAIL</a></p>\n" +
        "                                </div>\n" +
        "                            </td>\n" +
        "                        </tr>\n" +
        "                    </table>\n" +
